...
| dotSize | Size of each dot, defaults to 0.008 |  |
...
| range | Range radius in kilometers for selected marker |  |
| rangeColor | [r, g, b] of the range circle color, 0 ≤ r, g, b ≤ 1 |  |
| rangeOpacity | Opacity of the range circle, 0 ≤ rangeOpacity ≤ 1, defaults to 1 |  |
| selectedMarker | Index of selected marker (or null for none) |  |
| onMarkerSelect | Callback when a marker is clicked: (index, marker) => void |  |
